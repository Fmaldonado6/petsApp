...
public class UsersController {
    ...
    public ResponseEntity<List<User>> getAll() {
        try {
            ...
            return (ResponseEntity<List<User>>) new ResponseEntity((Object) list, HttpStatus.OK);
        } catch (Exception e) {
            return (ResponseEntity<List<User>>) new ResponseEntity((MultiValueMap) null, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public ResponseEntity<User> getById(@PathVariable final String id) {
        try {
            ...
            return (ResponseEntity<User>) new ResponseEntity((Object) obj, HttpStatus.OK);
        } catch (Exception e) {
            return (ResponseEntity<User>) new ResponseEntity((MultiValueMap) null, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
